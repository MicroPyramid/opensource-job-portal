	...
	<form onsubmit={(e) => { e.preventDefault(); if ((userType === 'company' && step === 3) || (userType === 'recruiter' && step === 2)) handleSubmit(); else nextStep(); }} class="space-y-5">
		{#if step === 0}
			...
			<div class="space-y-4">
				...
				<!-- Trust Indicators -->
				<div class="flex justify-center flex-wrap gap-3 my-4 text-sm text-gray-600">
				...
				<div class="mt-4">
					...
					<button
						...
						class="w-full flex items-center justify-center gap-3 px-4 py-2.5 border-2 border-gray-300 rounded-lg text-sm font-semibold text-gray-700 bg-white hover:border-gray-400 hover:shadow-md transition-all"
					>
